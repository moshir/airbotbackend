...
def createOrUpdateLexBot(identity,botid):
    ...
    for e in entities :
        botgraph["slots"][e.name]={
            ...
            "values" : json.loads(e.doc)["aliases"]
        }
        ...
        for v in variables :
            ...
            botgraph["slots"][nameslot]={
                ...
                "values" : json.loads(v.doc)["aliases"]
            }
            opslot=v.name+"op"
    ...
    for  i in intents :
        ...
        for r in rules :
            botgraph["intents"][i.name][r.name] = json.loads(r.doc)["expressions"]
...
if __name__=="__main__" :
    ...
    graph= App.route({
        ...
        "arguments": {
            "botid": "uri:bot:20180911183119:thisnewbot"
        },
        "identity": {
            "claims": {
